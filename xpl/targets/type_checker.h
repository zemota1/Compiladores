// $Id: type_checker.h,v 1.10 2017/05/10 15:46:48 ist181726 Exp $ -*- c++ -*-
...
namespace xpl {
  ...
  public:
    void not_node(cdk::not_node * const node, int lvl);
    void double_node(cdk::double_node * const node, int lvl);
    void and_node(cdk::and_node * const node, int lvl);
    void or_node(cdk::or_node * const node, int lvl);
